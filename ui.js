...
export const templates = {
    // In ui.js, inside the 'templates' object
...
dashboard: `
    ...
    <div class="bg-white dark:dark-bg-surface rounded-lg shadow-sm border border-slate-200 dark:dark-border-subtle">
        <div class="p-4 border-b dark:dark-border-subtle flex flex-wrap gap-4 justify-between items-center"><h2 class="text-xl font-bold dark:dark-text-primary">Recent Transactions</h2><div class="flex flex-wrap items-center gap-2"><input id="search-input" type="text" placeholder="Search..." class="w-48 p-2 border rounded-lg bg-slate-50 dark:dark-form-bg"><input type="date" id="filter-start-date" class="p-2 border rounded-lg bg-slate-50 dark:dark-form-bg"><input type="date" id="filter-end-date" class="p-2 border rounded-lg bg-slate-50 dark:dark-form-bg"></div></div>
        <div class="overflow-x-auto"><table class="w-full text-sm responsive-table"><thead><tr class="border-b dark:dark-border-subtle bg-slate-50 dark:bg-slate-900/50"><th class="text-left font-semibold py-3 px-4 dark:dark-text-secondary">Date</th><th class="text-left font-semibold py-3 px-4 dark:dark-text-secondary">Details</th><th class="text-right font-semibold py-3 px-4 dark:dark-text-secondary">Profit/Value</th><th class="text-right font-semibold py-3 px-4 dark:dark-text-secondary">Payable Bal</th><th class="text-right font-semibold py-3 px-4 dark:dark-text-secondary">Receivable Bal</th><th class="text-center font-semibold py-3 px-4 dark:dark-text-secondary">Actions</th></tr></thead><tbody id="transaction-history-body"></tbody></table></div>
        <div id="pagination-controls" class="flex justify-center items-center gap-4 p-4 border-t dark:dark-border-subtle"></div>
    </div>`,
    contacts: `
