        ...
        <div class="bg-white dark:bg-slate-900 rounded-lg shadow-sm border dark:border-slate-700">
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm responsive-table">
                    ...
                    <tbody id="contacts-table-body"><tr><td colspan="4"><div class="p-4 space-y-2"><div class="skeleton h-4 w-full"></div></div></td></tr></tbody>
                </table>
            </div>
        </div>
        <div id="contact-modal" class="hidden fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">{/* Modal HTML is in here, but hidden */}</div>
        <div id="direct-payment-modal" class="hidden fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4">{/* Modal HTML is in here, but hidden */}</div>
    `;
}
