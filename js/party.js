...
// The import for showContactLedger is no longer needed here as we navigate directly.
...
function initializePartyListeners() {
    ...
    appContent.addEventListener('submit', e => {
        ...
        if (e.target.id === 'direct-payment-form') handleDirectPaymentSubmit(e);
    });
...
// ✨ FIX: This function MUST be exported to be used by other files.
